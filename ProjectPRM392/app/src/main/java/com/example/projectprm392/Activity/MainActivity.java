...
import com.example.projectprm392.Adapter.PopularAdapter;
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        binding.recyclerViewPoppular.setLayoutManager(new GridLayoutManager(MainActivity.this,2));
                        binding.recyclerViewPoppular.setAdapter(new PopularAdapter(items));
                        binding.recyclerViewPoppular.setNestedScrollingEnabled(true);
                    }
